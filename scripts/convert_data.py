...
SEKAIPEDIA_TRANSLATIONS_FILE = PROJECT_ROOT / "sekaipedia_translations.json"
...
def load_sekaipedia_translations():
    ...
    if SEKAIPEDIA_TRANSLATIONS_FILE.exists():
        ...
        print("  Run 'python scripts/scrape_sekaipedia.py' first to generate it.")
        return {}
...
def main():
    ...
    for song in data['songs']:
        ...
        image_path = image_dir / f"{clean_filename(song['songId'])}.png"
    ...
    if failed_romaji:
        failed_file = PROJECT_ROOT / "failed_romaji.json"
