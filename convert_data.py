...
def get_english_translation(title, artist, song_id):
    ...
    known_translations = {
        ...
        'さくらんぼ': 'Cherry',
        '天体観測': 'Tentai Kansoku',
        '1/3の純情な感情': '1/3 Pure Feelings',
        'おじゃま虫': 'Ojama Mushi',
        'はじめまして地球人さん': 'Nice to Meet You, Earthling',
        'ファッとして桃源郷': 'Suddenly Shangri-La',
        '名探偵連続殺人事件': 'Great Detective\'s Serial Murder Case',
        'お気に召すまま': 'As You Like It',
        'いつかいい感じにアレしよう': 'Let\'s Do That Someday',
        '馬と鹿': 'Horse and Deer',
        '冬のこもりうた': 'Winter Lullaby',
        '秒針を噛む': 'Bite the Second Hand',
        '乙女のルートはひとつじゃない！': 'A Maiden\'s Route is Not Just One!',
        'ビックカメラのテーマソング': 'Bic Camera Theme Song',
        'おいでよ！妖精の森': 'Come to the Fairy Forest!',
        'みかんのうた': 'Mikan Song',
        'ほとんど違法行為': 'Almost Illegal',
        '青春はNon-Stop！': 'Seishun wa Non-Stop!',
        'ようかい体操第一': 'Yokai Exercise No. 1',
        'ゲラゲラポーのうた': 'Gera Gera Po Song',
        'でんでんぱっしょん': 'Dendendenpassion',
        '秘密の扉から会いにきて': 'Come Meet Me Through the Secret Door',
        'ひみつをちょーだい': 'Give Me Your Secret',
        '夏にキスしていいですか？': 'Can I Kiss You in Summer?',
        '紅蓮の弓矢': 'Crimson Bow and Arrow',

        '新宝島': 'New Treasure Island',
        '未完成人': 'Incomplete Person',
...
def get_romaji_override(title):
    ...
    romaji_overrides = {
        ...
        'じょいふる': 'Joyful',
        'サラバ、愛しき悲しみたちよ': 'Farewell, My Dear Sorrows',
        'あの世行きのバスに乗ってさらば。': 'Goodbye, Riding the Bus to the Afterlife',
        '吾輩よ猫であれ': 'I Am a Cat',
        ...
        '毒占欲': 'Doku Sen Yoku',
        'おじゃま虫': 'Ojama Mushi',
        'あ・え・い・う・え・お・あお!!': 'A E I U E O Ao!!',
        'ガヴリールドロップキック': 'Gabriel DropKick',
        'アンチクロックワイズ': 'Anti-Clockwise',
        '徒花ネクロマンシー': 'Adabana Necromancy',
        '目覚めRETURNER': 'Mezame Returner',
        '青空のラプソディ': 'Aozora no Rhapsody',
        'ラブ・ドラマティック feat. 伊原六花': 'Love Dramatic feat. Ihara Rikka',
        '異世界かるてっと': 'Isekai Quartet',
        'オトモダチフィルム': 'Tomodachi Film',
        '六厘歌': 'Rokubun no Ichi Uta',
        'ノーポイッ!': 'No Poi!',
        '町かどタンジェント': 'Machikado Tangent',
        'インフェルノ': 'Inferno',
        'LOVEドッきゅん♥': 'Love Dokkyun',
        'カルマ': 'Karma',
        'リライト': 'Rewrite',
        'リクライム': 'Reclaim',
        '恋のヒメヒメぺったんこ': 'Koi no Hime Hime Pettanko',
        'サブリナ': 'Sabrina',
        'ファミリーパーティー': 'Family Party',
        '恋愛サーキュレーション': 'Renai Circulation',
        'カノン': 'Canon',
        'オルフェ': 'Orpheus',
        'ヘタリアン☆ジェット': 'Hetalian Jet',
        'ココロオドル': 'Kokoro Odoru',
        '青春はNon-Stop！': 'Seishun wa Non-Stop!',
        'ようかい体操第一': 'Youkai Taisou Daiichi',
        'ゲラゲラポーのうた': 'Gera Gera Po no Uta',
        'でんでんぱっしょん': 'Dendendenpassion',
        'イチズレシピ': 'Ichizu Recipe',
        'ふ・れ・ん・ど・し・た・い': 'Fu Ren Do Shi Ta I',
        '未来(ソラ)の歌': 'Mirai (Sora) no Uta',
        'ひみつをちょーだい': 'Himitsu wo Choudai',
        'ゆりゆららららゆるゆり大事件': 'Yuri Yurararara Yuru Yuri Daijiken',
        'いぇす！ゆゆゆ☆ゆるゆり♪♪': 'Yes! YuYuYu Yuru Yuri',
        'ちょちょちょ！ゆるゆり☆かぷりっちょ！！！': 'Cho Cho Cho! Yuru Yuri Capriccio!!!',
        'SAKURAスキップ': 'Sakura Skip',
        'ホシトハナ': 'Hoshi to Hana',
        'ヤバい○○': 'Yabai ○○',
        '全力☆Summer!': 'Zenryoku Summer!',
        'にめんせい☆ウラオモテライフ！': 'Nimensei Ura-Omote Life!',
        'うまるん体操': 'Umaru Taisou',
        'かくしん的☆めたまるふぉ～ぜっ！': 'Kakushinteki Metamorphose!',
        'NOISY LOVE POWER☆': 'Noisy Love Power',
        '極上スマイル': 'Gokujou Smile',
        '甲賀忍法帖': 'Kouga Ninpouchou',
        'じょいふる': 'Joyful',
        '女々しくて': 'Memeshikute',
        'ニブンノイチ': 'Nibun no Ichi',
        'サラバ、愛しき悲しみたちよ': 'Saraba, Itoshiki Kanashimitachi yo',
        '愛を止めないで': 'Ai wo Tomenaide',
        '愛のシュプリーム！': 'Ai no Supreme!',
        'くらべられっ子': 'Kuraberarekko',
        'あの世行きのバスに乗ってさらば。': 'Ano Yo Iki no Bus ni Notte Saraba.',
        'うまぴょい伝説': 'Uma Pyoi Densetsu',
        '吾輩よ猫であれ': 'Wagahai yo Neko de Are',
        'Everyday、カチューシャ': 'Everyday, Katyusha',
        'つけまつける': 'Tsukematsukeru',
        'どうしてこうなった': 'Doushite Kou Natta',
        'おちゃめ機能': 'Ochame Kinou',
        'だんだん早くなる': 'Dandan Hayaku Naru',
        '犬日和。': 'Inu Biyori',
        'すーぱーぬこになりたい': 'Super Nuko ni Naritai',
        '東京リアルワールド': 'Tokyo Real World',
        'その群青が愛しかったようだった': 'Sono Gunjou ga Itoshikatta You Datta',
        '東奔西走行進曲': 'Touhon Seisou Koushinkyoku',
        'フレ！フレ！ベストフレンズ': 'Fure! Fure! Best Friends',
        'アウトサイダー': 'Outsider',
        '絵の上手かった友達': 'E no Jouzu Katta Tomodachi',
        'ワンダーラスト': 'Wanderlust',
        'ジャガーノート': 'Juggernaut',
